...
/**
  ...
  /**
   * `prisma.dotcorSchedules`: Exposes CRUD operations for the **DotcorSchedules** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more DotcorSchedules
    * const dotcorSchedules = await prisma.dotcorSchedules.findMany()
    * ```
    */
  get dotcorSchedules(): Prisma.DotcorSchedulesDelegate<ExtArgs, { omit: OmitOpts }>;
