/*
  ...
  - You are about to drop the column `stratDate` on the `schedules` table. All the data in the column will be lost.
  ...
  - Added the required column `stratDateTime` to the `schedules` table without a default value. This is not possible if the table is not empty.
...
DROP COLUMN "stratDate",
ADD COLUMN     "endDateTime" TIMESTAMP(3) NOT NULL,
ADD COLUMN     "stratDateTime" TIMESTAMP(3) NOT NULL;
