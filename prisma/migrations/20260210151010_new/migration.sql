...
CREATE TABLE "dotcor_schedules" (
    ...
    CONSTRAINT "dotcor_schedules_pkey" PRIMARY KEY ("doctorId","scheduleId")
);
...
-- CreateIndex
CREATE INDEX "dotcor_schedules_doctorId_idx" ON "dotcor_schedules"("doctorId");

-- CreateIndex
CREATE INDEX "dotcor_schedules_scheduleId_idx" ON "dotcor_schedules"("scheduleId");
...
-- AddForeignKey
ALTER TABLE "dotcor_schedules" ADD CONSTRAINT "dotcor_schedules_doctorId_fkey" FOREIGN KEY ("doctorId") REFERENCES "doctor"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dotcor_schedules" ADD CONSTRAINT "dotcor_schedules_scheduleId_fkey" FOREIGN KEY ("scheduleId") REFERENCES "schedules"("id") ON DELETE CASCADE ON UPDATE CASCADE;
